"""
Django settings for mygreenhouse project.
...
SECRET_KEY = '6e*e5+c@eq9g9c@+-vw(xig90p%@6o+03tx0*f)9p)h35rtjie'
...
#ALLOWED_HOSTS = ['f61a8aa03bc8450a8bc9cb6b249ef7f4.vfs.cloud9.eu-west-1.amazonaws.com']
#ALLOWED_HOSTS = ['23119233-greenhouse-env.eba-w8jp5pvn.eu-west-1.elasticbeanstalk.com']
...
ROOT_URLCONF = 'mygreenhouse.urls'
...
WSGI_APPLICATION = 'mygreenhouse.wsgi.application'
